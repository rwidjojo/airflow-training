...
COPY_MONTHLY_TRIPS_SQL = COPY_SQL.format(
    "trips",
    "s3://pmi-airflow/divvy/partitioned/{year}/{month}/divvy_trips.csv"
)

COPY_ALL_TRIPS_SQL = COPY_SQL.format(
    "trips",
    "s3://pmi-airflow/Divvy_Trips_2018_2.csv"
)

COPY_STATIONS_SQL = COPY_SQL.format(
    "stations",
    "s3://pmi-airflow/divvy/unpartitioned/divvy_stations_2017.csv"
)
