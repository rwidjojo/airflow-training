...
TEST_KEY = 'pmi.txt'
LOCAL_FILE = f'/home/airflow/airflow/dags/{owner}/pmi.txt'
file_name = 'santa.jpg'
bucket_folder = 'Salim_Paulus_Indra'
...
def download_file(bucket,destination):
    ...
    try:
        s3.Bucket(TEST_BUCKET).download_file(TEST_KEY, file_name)
    except :
...
def upload_file(source, bucket):
    ...
    s3.meta.client.upload_file(LOCAL_FILE, bucket, f'{bucket_folder}/{file_name}')
