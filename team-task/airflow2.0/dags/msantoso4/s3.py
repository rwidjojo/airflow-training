...
dag = DAG('merlin_test_s3_download',
...
TEST_KEY = 'pmi.txt'
LOCAL_FILE = '/home/airflow/airflow/dags/msantoso4/pmi.txt'
...
def download_file(bucket,destination):
    ...
    try:
        s3.Bucket(TEST_BUCKET).download_file(TEST_KEY, '/home/airflow/airflow/dags/msantoso4/santa.jpg')
    except :
...
def upload_file(source, bucket):
    ...
    s3.meta.client.upload_file(LOCAL_FILE, bucket, f"Santoso_Merlin/{TEST_KEY}")
