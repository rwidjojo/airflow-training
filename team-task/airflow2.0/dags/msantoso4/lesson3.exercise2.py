...
dag = DAG(
    ...
    description='Migrate data from postgresql',
    schedule_interval=None,
)

def migrate_data():
  src_conn = PostgresHook(postgres_conn_id='msantoso4_postgree')
  dest_conn = PostgresHook(postgres_conn_id='msantoso4_postgree2')
