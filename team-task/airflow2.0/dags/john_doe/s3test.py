...
TEST_KEY = 'pmi.txt'
LOCAL_FILE = '/home/ubuntu/airflow/dags/john_doe/pmi.txt'
...
def download_file(bucket,destination):
    ...
    try:
        s3.Bucket(TEST_BUCKET).download_file(TEST_KEY, '/home/airflow/airflow/dags/john_doe/my_local_image.jpg')
    except :
