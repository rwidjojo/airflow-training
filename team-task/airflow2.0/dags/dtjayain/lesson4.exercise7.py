...
def _is_multiplied_by_4(**kwargs):
  ...
  if execution_date.day % 4 == 0:
    raise AirflowSkipException("Skipped since the day is the multiplication by 4!")

multiplied4_task = PythonOperator(
    task_id="multiply_by_4",
...
def _pick_migration(**kwargs):
  ...
  if execution_date.day % 2 == 0:
    return 'multiply_by_4' # returning task id `multiplied4_task`
  else:
...
greet_task >> migration_branch >> [multiplied4_task, migrate_odd_task]
multiplied4_task >> migrate_even_task