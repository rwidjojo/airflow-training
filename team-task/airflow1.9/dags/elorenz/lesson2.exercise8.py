...
def completed_task(**kwargs):
    ti = kwargs['ti']
    ## Pull xcom here 
    addition_result=ti.xcom_pull(task_ids='addition')
    subs_result=ti.xcom_pull(task_ids='subtraction')
    div_result=ti.xcom_pull(task_ids='division')
    summary = addition_result + subs_result + div_result # calculate xcom result here
