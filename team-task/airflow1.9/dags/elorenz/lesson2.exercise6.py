...
subtraction_task = PythonOperator(
    ...
    python_callable=calculator,
    op_kwargs={'operator': '-', 'number1': 7, 'number2': 4}, # fill argument subraction calculation here
    dag=dag,
)
...
multiplication_task = PythonOperator(
    ...
    python_callable=calculator,
    op_kwargs={'operator': '*', 'number1': 3, 'number2': 2}, # fill argument multiplication calculation here
    dag=dag,
)
