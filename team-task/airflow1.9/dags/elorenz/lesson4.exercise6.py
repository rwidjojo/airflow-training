...
migrate_3d_task= PythonOperator(
    task_id="migrate_3d",
    python_callable=migrate_3d,
    provide_context=True,
    dag=dag
)
...
def _pick_migration(**kwargs):
  ...
  if execution_date.day % 3 == 0:
    return 'migrate_3d' # returning task id `migrate_3d`
...
greet_task >> migration_branch >> [migrate_3d_task, migrate_even_task, migrate_odd_task]