...
addition_task = PythonOperator(
    ...
    op_kwargs={'operator': '+', 'number1': 6, 'number2': 3}, # fill argument addition calculation here
    dag=dag,
)
...
subtraction_task = PythonOperator(
    ...
    python_callable=calculator,
    op_kwargs={'operator': '-', 'number1': 6, 'number2': 3}, # fill argument subraction calculation here
    dag=dag,
)
...
multiplication_task = PythonOperator(
    ...
    python_callable=calculator,
    op_kwargs={'operator': '*', 'number1': 6, 'number2': 3}, # fill argument multiplication calculation here
    dag=dag,
)
...
division_task = PythonOperator(
    ...
    python_callable=calculator,
    op_kwargs={'operator': '/', 'number1': 6, 'number2': 3}, # fill argument division calculation here
    dag=dag,
)
