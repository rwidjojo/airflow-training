...
def completed_task(**kwargs):
    ti = kwargs['ti']
    ## Pull xcom here
    addition_res, substraction_res, division_res = ti.xcom_pull(key=None, task_ids=['addition', 'substraction', 'division'])
    summary = addition_res + substraction_res + division_res
