...
migrate_3rd_task = PythonOperator(
    task_id="migrate_3rd",
    python_callable=migrate_3rd_day,
    provide_context=True,
    dag=dag,
)
...
greet_task >> migration_branch >> [migrate_3rd_task, migrate_even_task, migrate_odd_task]