...
def _odd_process():
    print("This is just odd process after branch_odd_task")
...
branch_odd_task = BashOperator(
    task_id="branch_odd",
    bash_command=f'echo "Today is odd, so this one is executed"',
    dag=dag,
)

branch_even_task = BashOperator(
    task_id="branch_even",
    bash_command=f'echo "Today is even, so this one is executed"',
    dag=dag,
)
